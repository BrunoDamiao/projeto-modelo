...
class CategorySysController extends BaseController
{

    private $model;
    private $root   = '/admin/category';
    ...
    */
        ...
        public function getIndex()
        {
            ...
            // pp($data,1);
            Container::getView('admin.categorySys.categorySys', compact('title','data'));
        }
        ...
        public function getCreate()
        {
            ...
            Container::getView('admin.categorySys.categorySys-new-edit', compact('title','data'));
        }
        ...
        public function getDelete()
        {
            ...
            $StrDelete .= "<a href='{$this->root}/destroy/{$data->level_id}' class='btn btn-success btn-xs' title='Sim'>Sim<i class='glyphicon glyphicon-ok-sign'> </i></a> ";
            $StrDelete .= " | ";
            $StrDelete .= " <a href='{$this->root}' class='btn btn-danger btn-xs' title='Não' data-dismiss='alert' aria-hidden='true'>Não<i class='glyphicon glyphicon-remove-sign'></i></a>";
    ...
    */
        ...
        public function postEdit()
        {
            ...
            if ($validate->getStatus()) {
                ...
                setMsgFlash('warning', $validate->getMessages());
                return redirect("{$this->root}/edit/{$id}");
            }
