...
class LevelAuthController extends BaseController
{
    ...
    */
        ...
        public function getIndex()
        {
            ...
            $data = $this->model
                ...
                // ->where('tb_level.level_category', $authSession->session_category, '!=')
                ->where('tb_level.level_category', 'MASTERKEY', '!=')
                ->where('tb_level.level_name', '--', '!=')
                ->all();

            // pp($data->getResult(),1);
            Container::getView('admin.levelauth.levelauth', compact('title','data'));
        }
        ...
        public function getCreate()
        {
            ...
            Container::getView('admin.levelauth.levelauth-new-edit', compact('title','data','category'));
        }
